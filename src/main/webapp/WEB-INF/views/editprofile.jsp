...
<body>
    ...
    <div class="col-md-6 col-md-offset-3 well">
        <h3><a href="../<sec:authentication property="principal.id" />"> Profile</a> > edit</h3>

        <form:form class="form" action="edit" method="post" modelAttribute="signupForm">
            <div class="formInfo">
                <s:bind path="*">
                    <c:choose>
            ...
            <div class="form-group">
                ...
                <form:password showPassword="true" class="form-control" path="password" />
            </div>
            <div class="form-group">
                ...
                <form:password showPassword="true" class="form-control" path="repeatedPassword" />
            </div>
            <div class="form-group">
                <p>* Required</p>
