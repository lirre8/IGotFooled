...
import com.courseportal.project.facebook.PostToWallAfterConnectInterceptor;
import com.courseportal.project.signin.SimpleSignInAdapter;
import com.courseportal.project.twitter.TweetAfterConnectInterceptor;
...
public class SocialConfig implements SocialConfigurer {
	...
	public ProviderSignInController providerSignInController(ConnectionFactoryLocator connectionFactoryLocator, UsersConnectionRepository usersConnectionRepository) {
		return new ProviderSignInController(connectionFactoryLocator, usersConnectionRepository, new SimpleSignInAdapter(new HttpSessionRequestCache(), accountRepository));
	}
